...
"""Program:  create_header.py
    ...
    Description:  Unit testing of create_header in elastic_db_admin.py.

    Usage:
        test/unit/elastic_db_admin/create_header.py
...
class UnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.name = "Memory"
        self.results = "Elastic_DB_Admin"
        self.results2 = "Memory"
    ...
    def test_check_header(self):
        ...
        self.assertEqual(
            elastic_db_admin.create_header(self.dtg, name=self.name)["Check"],
            self.results2)
    ...
    def test_base_header(self):
        ...
        self.assertEqual(
            elastic_db_admin.create_header(self.dtg)["Application"],
            self.results)
