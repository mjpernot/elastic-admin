#!/bin/bash
# Unit test code coverage for SonarQube to cover the elastic_db_admin functions.
...
coverage run -a --source=elastic_db_admin test/unit/elastic_db_admin/create_header.py
coverage run -a --source=elastic_db_admin test/unit/elastic_db_admin/data_out.py
...
coverage run -a --source=elastic_db_admin test/unit/elastic_db_admin/print_failures.py
